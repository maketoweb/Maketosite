...
const headerHTML = `
    <header>
        <div class="logo"><a href="/"></a>
           <img src="/imagen/logo.png" alt=""> </div>
...
const footerHTML = `
    <footer>
        <div class="footer-column footer-info" style="max-width: 300px;">
            <h4>Maketo Web | Metodología de Alto Rendimiento</h4>
            <p>Somos la agencia con 5 años de expertiz que convierte gastos en inversiones. Creamos máquinas de ventas, no solo páginas bonitas.</p>
        ...
        <div class="footer-column">
            ...
            <ul>
                <li><a href="/blog">Blog</a></li>
                <li><a href="/nosotros">Portafolio (Casos Conceptuales)</a></li>
                <li><a href="/servicios">Servicios (Contado)</a></li>
            </ul>
        </div>
        <div class="footer-column">
            <h4>Planes Flex</h4>
            <ul>
                <li><a href="/ve/planes">Venezuela</a></li>
                <li><a href="/co/planes">Colombia</a></li>
                <li><a href="/es/planes">España</a></li>
            </ul>
        </div>
        <div class="footer-column">
        ...
        <div class="footer-copyright">
            <p>Copyright © 2025 Maketo Web. | 5 Años de Expertiz en Metodología de Alto Rendimiento.</p>
        </div>
    </footer>
`;
